# h3bcam — turn a GoPro HERO3 Black into a real USB webcam

![demo image](sample.jpg)

Patches GoPro HERO3 Black firmware to create a real UVC webcam, 1280×960@30fps.

Once it's patched, no additional software or drivers needed - works everywhere
you'd expect.
...
> a 15-year-old camera. By continuing, you accept these risks.
...
> [!IMPORTANT]
> Do this **before** you install anything, if you want the option of restoring
> your camera's exact original firmware. These are the only copies that exist —
> this repo can't ship them, and GoPro's download is the generic image rather
> than whatever your specific camera shipped with.
